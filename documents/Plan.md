...
2. *Месяц* двузначное число от 01 до 12, при этом месяц не должен быть меньше текущего месяца, если указан текущий год.
3. *Год* последние две цифры текущего года, если указан месяц меньше текущего, или текущий год + 3 года.
4. *Владелец*  имя и фамилия владельца карты, состоящие из двух слов через пробел на латинице (допустимо наличие дефиса в имя и/или фамилия).
5. *CVC/CVV* - 3-х значный номер, 
...
4. Ввести в поле "Месяц" двузначное число от 01 до 12, при этом месяц не должен быть меньше текущего месяца, если указан текущий год.
5. Ввести в поле "Год" последние две цифры текущего года, если указан месяц меньше текущего, или текущий год + 3 года.
6. В поле "Владелец" ввести имя и фамилия владельца карты, состоящие из двух слов через пробел на латинице (допустимо наличие дефиса в имя и/или фамилия).
7. Ввести в поле "CVC/CVV" - 3-х значный номер (например: 789)
...
5. Ввести в поле "Год" последние две цифры текущего года, если указан месяц меньше текущего, или текущий год + 3 года.
6. В поле "Владелец" ввести имя и фамилия владельца карты, состоящие из двух слов через пробел на латинице (допустимо наличие дефиса в имя и/или фамилия).
7. Ввести в поле "CVC/CVV" - 3-х значный номер (например: 456)
8. Нажать кнопку "Продолжить"
